    ...
    return (
        <div className="container">
            <div className="translator-wrapper">
                <div className="translator-text-input">
                    <textarea
                        name="from"
                        className="translator-from-text"
                ...
                <ul className="translator-controls">
                    <li className="translator-row translator-from">
                    ...
                    <li className="translator-exchange" onClick={handleExchange}>
                        <i className="fa-solid fa-arrow-right-arrow-left"></i>
                    </li>
                    <li className="translator-row translator-to">
                        <select
                            value={toLanguage}
